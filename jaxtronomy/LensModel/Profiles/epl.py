...
class EPLMajorAxis(LensProfileBase):
    ...
    def derivatives(x, y, b, t, q):
        ...
        alpha_real = jnp.nan_to_num(alpha.real, posinf=1e10, neginf=-1e10)
        alpha_imag = jnp.nan_to_num(alpha.imag, posinf=1e10, neginf=-1e10)
    ...
    def hessian(x, y, b, t, q):
        ...
        # convergence, eq. (2)
        kappa = (2 - t) / 2 * (b / R) ** t
        kappa = jnp.nan_to_num(kappa, posinf=1e10, neginf=-1e10)
        ...
        gamma_1 = jnp.nan_to_num(gamma_1, posinf=1e10, neginf=-1e10)
        gamma_2 = jnp.nan_to_num(gamma_2, posinf=1e10, neginf=-1e10)
