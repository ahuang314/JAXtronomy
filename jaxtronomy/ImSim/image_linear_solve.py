...
class ImageLinearFit(ImageModel):
    ...
    def image_linear_solve(
        ...
        """
        # NOTE: pixelbased solve is not supported in jaxtronomy
    ...
    @partial(jit, static_argnums=(0, 7, 9))
    ...
    @partial(jit, static_argnums=(0, 9, 11))
    ...
    def linear_response_matrix(
        ...
        source_light_response, _ = self.source_mapping.image_flux_split(
